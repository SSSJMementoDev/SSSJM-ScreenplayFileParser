...
public class GettingScreenplayScriptVariableImpl extends ASTWrapperPsiElement implements GettingScreenplayScriptVariable {

  public GettingScreenplayScriptVariableImpl(@NotNull ASTNode node) {
    super(node);
  }
