...
public class GettingScreenplayScriptOptionContentImpl extends ASTWrapperPsiElement implements GettingScreenplayScriptOptionContent {

  public GettingScreenplayScriptOptionContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GettingScreenplayScriptVisitor visitor) {
    visitor.visitOptionContent(this);
  }
