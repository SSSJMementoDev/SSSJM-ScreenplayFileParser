...
public class GettingScreenplayScriptMainParamImpl extends ASTWrapperPsiElement implements GettingScreenplayScriptMainParam {

  public GettingScreenplayScriptMainParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GettingScreenplayScriptVisitor visitor) {
    visitor.visitMainParam(this);
  }
