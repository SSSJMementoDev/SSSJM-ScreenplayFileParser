...
public class GettingScreenplayScriptSubParamValueImpl extends ASTWrapperPsiElement implements GettingScreenplayScriptSubParamValue {

  public GettingScreenplayScriptSubParamValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GettingScreenplayScriptVisitor visitor) {
    visitor.visitSubParamValue(this);
  }
  ...
  @Override
  @Nullable
  public GettingScreenplayScriptOption getOption() {
    return findChildByClass(GettingScreenplayScriptOption.class);
  }
