...
public class GettingScreenplayScriptJsonImpl extends ASTWrapperPsiElement implements GettingScreenplayScriptJson {

  public GettingScreenplayScriptJsonImpl(@NotNull ASTNode node) {
    super(node);
  }
