...
public class GettingScreenplayScriptSubParamKeyImpl extends ASTWrapperPsiElement implements GettingScreenplayScriptSubParamKey {

  public GettingScreenplayScriptSubParamKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GettingScreenplayScriptVisitor visitor) {
    visitor.visitSubParamKey(this);
  }
  ...
  public PsiElement getAlphabet() {
    return findNotNullChildByType(ALPHABET);
  }
