...
public class GettingScreenplayScriptOptionTargetImpl extends ASTWrapperPsiElement implements GettingScreenplayScriptOptionTarget {

  public GettingScreenplayScriptOptionTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GettingScreenplayScriptVisitor visitor) {
    visitor.visitOptionTarget(this);
  }
