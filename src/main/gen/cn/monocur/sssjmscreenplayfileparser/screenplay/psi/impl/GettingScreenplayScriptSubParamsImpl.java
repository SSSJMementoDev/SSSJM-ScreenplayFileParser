...
public class GettingScreenplayScriptSubParamsImpl extends ASTWrapperPsiElement implements GettingScreenplayScriptSubParams {

  public GettingScreenplayScriptSubParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GettingScreenplayScriptVisitor visitor) {
    visitor.visitSubParams(this);
  }
  ...
  @Override
  @NotNull
  public List<GettingScreenplayScriptSubParam> getSubParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GettingScreenplayScriptSubParam.class);
  }
